...
import { AddressLink, Container, StyledLink, Title, AddressItem, PhonesList, PhonesListItem } from './FooterAddress.styled';
...
const FooterAddress: FC = () => {
  return (
    <Container>
      ...
      <AddressItem>
        <AddressLink href='https://maps.app.goo.gl/ECQY42SvmE4U4Fs77' target='_blank' rel='noopener noreferrer nofollow'>
